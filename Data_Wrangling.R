...
# song_info is the final dataframe.
  ...
  #Energy is a measure from 0 to 100 and represents a perceptual measure of intensity and activity. Typically, energetic tracks 
  ...
  ##Danceability Variable Description
